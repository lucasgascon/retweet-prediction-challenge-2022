...
# Create a vectorizer on all the text data of the train.csv and evaluation.csv tweets
...
# add a pos, neg or compound sentiment to analyse the text
...
def load_train_data(test, vectorizer_text):
    ...
    X_train, vectorizer_text = preprocessing(X_train, train = True, vectorizer_text = vectorizer_text)
    if test == True: 
...
def main_preprocessing():
    ...
    vectorizer_text = None
    X_train, y_train, X_test, y_test, vectorizer_text = load_train_data(test=True, vectorizer_text = vectorizer_text)
    X, y, vectorizer_text = load_train_data (test=False, vectorizer_text = vectorizer_text)
